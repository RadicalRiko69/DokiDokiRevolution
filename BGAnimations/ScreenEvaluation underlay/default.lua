...
if not GAMESTATE:IsCourseMode() then
	...
	t[#t+1] = Def.ActorFrame {
		OnCommand=cmd(x,SCREEN_CENTER_X-175;y,SCREEN_CENTER_Y-66;rotationz,-6;SetUpdateFunction,CDTitleUpdate);
	...
	--PHONE BURN
	t[#t+1] = Def.Quad {
		InitCommand=cmd(scaletoclipped,253,137;diffuseshift;effectcolor1,color("#525252");effectcolor2,color("#666666");effectperiod,1;
		MaskDest;blend,Blend.Multiply;rotationz,-6;x,SCREEN_CENTER_X-175;y,SCREEN_CENTER_Y-66);
	};
...
t[#t+1] = Def.ActorFrame{
	...
	LoadActor(THEME:GetPathB("","ScreenSelectMusic decorations/banner shine.png"))..{
		InitCommand=cmd(zoom,0.5;rotationz,-6;blend,Blend.Add;x,SCREEN_CENTER_X-175;y,SCREEN_CENTER_Y-66);
	};
	-- HELP TEXT	
...
t[#t+1] = Def.ActorFrame {
	...
	Def.Sprite{
		...
		SongChosenMessageCommand=cmd(stoptweening;decelerate,0.1;x,SCREEN_CENTER_X-70;y,SCREEN_CENTER_Y+80),
		...
		Texture= THEME:GetPathB("","ScreenSelectMusic decorations/sarena 2x1.png"),
	},
	--CYNTHIA
	Def.Sprite{
		Name= "Cynthia",
		...
		SongChosenMessageCommand=cmd(stoptweening;decelerate,0.1;x,SCREEN_CENTER_X-150;y,SCREEN_CENTER_Y+80),
		...
		ResetAnimCommand=cmd(setstate,0);
		Texture= THEME:GetPathB("","ScreenSelectMusic decorations/cynthia 2x1.png"),
	},
	--SAYORI
	Def.Sprite{
		Name= "Sayori",
